...
SECTION_HEADERS: dict[str, JobDescpSection] = {
    "requirements": JobDescpSection(
        weight=1.0,
        headers=["requirements", "qualifications", "must have", "what we’re looking for", "what we're looking for"],
    ),
    ...
    "about": JobDescpSection(
        weight=0.3,
        headers=["about", "about us", "who we are", "tech stack", "our stack", "our technology stack"],
    )
}
